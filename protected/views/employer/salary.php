...
<div class="salarydetails">
	...
	<dl class="clearfix debit"> 
	    ...
	    <dd id="pr_debit_gongsifangjia"><?php echo CHtml::encode($model->debit_gongsifangjia);?></dd> 
	    ...
	    <dd id="pr_debit_hunjia"><?php echo CHtml::encode($model->debit_hunjia);?></dd> 
	    ...
	    <dd id="pr_debit_chanjia"><?php echo CHtml::encode($model->debit_chanjia);?></dd> 
	    ...
	    <dd id="pr_debit_sangjia"><?php echo CHtml::encode($model->debit_sangjia);?></dd> 
	    ...
	    <dd id="pr_debit_shijia"><?php echo CHtml::encode($model->debit_shijia);?></dd> 
	    ...
	    <dd id="pr_debit_bingjia"><?php echo CHtml::encode($model->debit_bingjia);?></dd> 
	    ...
	    <dd id="pr_debit_kuanggong"><?php echo CHtml::encode($model->debit_kuanggong);?></dd> 
	    ...
	    <dd id="pr_debit_chidaozaotui"><?php echo CHtml::encode($model->debit_chidaozaotui);?></dd> 
	    ...
	    <dd id="pr_debit_qita"><?php echo CHtml::encode($model->debit_qita);?></dd> 
